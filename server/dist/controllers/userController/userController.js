...
exports.getRecentUserVisits =
  exports.addRecentUserVisit =
  exports.getUser =
  exports.userWeekdaySchedule =
  exports.userVisit =
  exports.userProfessorDeleteSchedule =
  exports.userProfessorEditSchedule =
  exports.userProfessorAllSchedule =
  exports.userProfessorSchedule =
  exports.userChatHistory =
  exports.userChatAI =
  exports.userUpdateByAdmin =
  exports.userDelete =
...
const user_register = async (req, resp) => {
  ...
  try {
    ...
    const formattedBirthday = (0, dayjs_1.default)(birthday).format(
      "YYYY-MM-DD"
    );
