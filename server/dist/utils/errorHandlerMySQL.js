...
const errorHandlerMySQL = (req, resp, err_message, err_no) => {
    switch (err_no) {
        case 1062: {
            ...
            if (match) {
                ...
                if (key.includes("email")) {
                    ...
                    resp.status(400).json({
                        error: "School assigned number is already in use. Make sure to use the number assigned to you by TCU.",
                    });
                    return;
                }
            }
...
exports.default = errorHandlerMySQL;
